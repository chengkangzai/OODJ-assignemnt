...
import GUI.User.CreateDelivery;
import GUI.User.CreateManage;
...
public class StaffDirectory extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Staff Directory");
        ...
        jButton3.setText("Managing Staff");
        ...
        jButton4.setText("Delivery Staff");
        ...
        for (int i = 0; i < model.getRowCount(); i++) {
            ...
            switch (role) {
                ...
                case "delivery":
                    ...
                    dStaff.setUser(new User().where("id", userId));
